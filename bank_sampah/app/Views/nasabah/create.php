...
<form action="<?= base_url(); ?>/nasabah/save" class="user" method="post">
    <?= csrf_field() ?>
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <input type="text" class="form-control form-control-user <?= ($validation->hasError('atm')) ? 'is-invalid' : ''; ?>" name="atm" placeholder="No Rekening" value="<?= old('atm') ?>">
